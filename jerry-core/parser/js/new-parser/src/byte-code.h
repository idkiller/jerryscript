...
#define CBC_HAS_BRANCH_ARG             0x04

#define CBC_ARG_TYPES (CBC_HAS_BYTE_ARG | CBC_HAS_LITERAL_ARG | CBC_HAS_BRANCH_ARG)
...
#define CBC_LVALUE_WITH_IDENT 2
#define CBC_LVALUE_WITH_PROP_STRING 4

#define CBC_UNARY_OP_TOKEN_TO_OPCODE(token_type) \
   ((((token_type) - LEXER_UNARY_PLUS) * 2) + CBC_UNARY_PLUS)

#define CBC_UNARY_LVALUE_OP_TOKEN_TO_OPCODE(token_type) \
   ((((token_type) - LEXER_KEYW_DELETE) * 6) + CBC_DELETE)

#define CBC_BINARY_OP_TOKEN_TO_OPCODE(token_type) \
   ((((token_type) - LEXER_LOGICAL_OR) * 3) + CBC_LOGICAL_OR)

#define CBC_BINARY_LVALUE_OP_TOKEN_TO_OPCODE(token_type) \
   ((((token_type) - LEXER_ASSIGN) * 6) + CBC_ASSIGN)
...
#define CBC_BRANCH_OFFSET_LENGTH(opcode) \
  (((opcode) - CBC_CURRENTLY_UNUSED_1) & 0x3)

#define CBC_BRANCH_IS_BACKWARD(opcode) \
  (((opcode) - CBC_CURRENTLY_UNUSED_1) & 0x4)
...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_PUSH_UNDEFINED_BASE, CBC_NO_FLAG, 1) \
  ...
  \
  /* Branch and some other opcodes. */ \
  CBC_OPCODE (CBC_CURRENTLY_UNUSED_1, CBC_NO_FLAG, 0) \
  CBC_BRANCH_OPERATION (CBC_JUMP_FORWARD, 0) \
  CBC_OPCODE (CBC_CURRENTLY_UNUSED_2, CBC_NO_FLAG, 0) \
  CBC_BRANCH_OPERATION (CBC_JUMP_BACKWARD, 0) \
  CBC_OPCODE (CBC_CURRENTLY_UNUSED_3, CBC_NO_FLAG, 0) \
  CBC_BRANCH_OPERATION (CBC_BRANCH_IF_TRUE_FORWARD, -1) \
  CBC_OPCODE (CBC_CURRENTLY_UNUSED_4, CBC_NO_FLAG, 0) \
  CBC_BRANCH_OPERATION (CBC_BRANCH_IF_TRUE_BACKWARD, -1) \
  CBC_OPCODE (CBC_CURRENTLY_UNUSED_5, CBC_NO_FLAG, 0) \
  CBC_BRANCH_OPERATION (CBC_BRANCH_IF_FALSE_FORWARD, -1) \
  CBC_OPCODE (CBC_CURRENTLY_UNUSED_6, CBC_NO_FLAG, 0) \
...
typedef struct
{
  uint8_t byte_argument;         /**< byte argument */
