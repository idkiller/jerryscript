...
#define PARSER_STACK_PAGE_SIZE (64 - sizeof (void*))
...
typedef struct
{
  ...
  cbc_argument last_cbc_arg;            /**< argument of the last cbc */
  uint8_t last_cbc_opcode;              /**< opcode of the last cbc */
...
void parser_stack_peek (parser_context *, void *, size_t);
void parser_stack_pop (parser_context *, size_t);
void parser_stack_iterator_init (parser_context *, parser_stack_iterator *);
void parser_stack_iterator_skip (parser_stack_iterator *, size_t);
uint8_t parser_stack_iterator_read_uint8 (parser_stack_iterator *);
...
void parser_post_processing (parser_context *);
